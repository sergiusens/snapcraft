...
from snapcraft.internal.meta.app import app, errors
...
class AppCommandTest(unit.TestCase):
    ...
    def test_app_no_change(self):
        ...
        self.expectThat(
            application.get_yaml(prepend_command_chain=["prepend-command-chain"]),
            Equals(
                {
                    "command": "test-command",
                    "stop-command": "test-stop-command",
        ...
        application.generate_command_wrappers()
    ...
    def test_socket_mode_change_to_octal(self):
        ...
        self.expectThat(
            type(
                application.get_yaml(prepend_command_chain=[])["sockets"]["sock2"][
                    "socket-mode"
                ]
            ),
...
class WrapperUseTest(unit.TestCase):
    ...
    def test_wrapper(self):
        ...
        self.assertThat(application._can_use_wrapper(), Equals(self.expect_wrappers))
